        ...
        <div class="page-options d-flex">
            <div class="input-icon ml-2">
                ...
                <form action="" method="GET">
                    ...
                    <input type="text" class="form-control w-12" placeholder="Cari Mahasiswa, masukan nama" name="q">
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('siswa.create') }}" class="btn btn-outline-primary btn-sm ml-5">Tambah Mahasiswa</a>
                </div>
                @if(session()->has('msg'))
